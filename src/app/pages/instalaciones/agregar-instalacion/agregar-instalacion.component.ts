...
export class AgregarInstalacionComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedRouted.params.subscribe(
      (params) => {
        this.idInsEquipo = params['idInsEquipo'];
        if (this.idInsEquipo) {
  ...
  obtenerModulo() {
    this.moduService.obtenerModulo(this.idInsEquipo).subscribe(
      (response: any) => {
        this.insEquipoForm.patchValue({
          nombre: response.data.nombre,
          descripcion: response.data.descripcion,
          idInsEquipo: response.data.idInsEquipo,
        });
      }
    );
  }
  ...
  actualizar() {
    ...
    this.instalacionService.actualizarInstalacion(this.idInsEquipo, payload).subscribe(
      (response: any) => {
        this.submitButton = 'Actualizar';
        this.loading = false;
        Swal.fire({
